...
export const verifyAccessToken = (accessToken: string, accessTokenSecret: string): JwtPayload => {
...
export function signToken(payload: object, secret: string, expiresIn: TokenExpiry): string {
