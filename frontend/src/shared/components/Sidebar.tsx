...
export const Sidebar: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Logo */}
      <div className="flex items-center px-4 py-4 min-h-[84px] font-['Plus_Jakarta_Sans',sans-serif]">
        <div className="flex items-center gap-3.5">
          ...
          {!isCollapsed && (
            <div className="flex flex-col">
              ...
              <span className="text-2xl font-[900] tracking-[-0.02em] text-white leading-tight">
