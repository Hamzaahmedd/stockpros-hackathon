 ...
 * This is a "no new regressions" gate, not a "zero vulnerabilities" gate: run
 * `npm audit` directly to see the full picture, and update audit-baseline.json
 * when a listed package is upgraded/replaced and its finding disappears.
 */
